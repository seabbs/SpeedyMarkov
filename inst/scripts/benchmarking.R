...
two_state_bench_dur_100 <- benchmark_markov(markov_model = example_two_state_markov,
                                    ...
                                    duration = 100, samples = 10000,
                                    times = 10)

saveRDS(two_state_bench_dur_100, "inst/benchmarks/two_state_duration_100.rds")

# Benchmarks for two state with 1000 duration
two_state_bench_dur_1000 <- benchmark_markov(markov_model = example_two_state_markov,
                                            reference = reference_two_state_markov,
                                            duration = 1000, samples = 10000,
                                            times = 10)

saveRDS(two_state_bench_dur_1000, "inst/benchmarks/two_state_duration_1000.rds")